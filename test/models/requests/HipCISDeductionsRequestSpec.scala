...
class HipCISDeductionsRequestSpec extends AnyWordSpec with Matchers {
  ...
  private val periodData: Array[PeriodData] = Array(
    PeriodData("2019-08-24", "2019-08-24", Some(BigDecimal(12.34)), BigDecimal(45.67), Some(BigDecimal(89.01))))
